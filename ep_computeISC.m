...
scramble_reps_to_include = [3]; control_reps_to_include = [1 2];
...
if strcmp(preproc_type, 'AFNI')
    ...
    ROIs = {'AngularG', 'Cerebellum', 'HeschlsG', 'STG', 'MotorCortex', ...
        'TPJ', 'PCC', 'Precuneus', 'A1', 'mPFC', 'Hipp', 'lTPJ', 'rTPJ', 'PMC', 'V1'};
    
    filepath = ['../../common_space_AFNI/reshaped_by_conditions/' preproc_params '/nROIs=15/sub-'];
    barcolor = [.9 .5 0];
